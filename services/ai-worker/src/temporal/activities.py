...
def create_activity_functions(resource_manager) -> Dict[str, Callable]:
    ...
    async def generate_structured_content(
        ...
        async with resource_manager.llm_semaphore:
            try:
                ...
                response_schema = resource_manager.get_schema_by_name(response_schema_name)
    ...
    async def update_stage(
        ...
        async with resource_manager.db_semaphore:
            try:
                ...
                updated_status = await resource_manager.db_manager.update_world_generation_stage(
                    world_id=world_id,
                    stage=stage,
                    status=status
                )
    ...
    async def increment_cost(
        ...
        async with resource_manager.db_semaphore:
            try:
                ...
                updated_status = await resource_manager.db_manager.increment_world_generation_cost(
                    world_id=world_id,
                    cost_type=cost_type,
                    cost=cost
                )
    ...
    async def update_progress(
        ...
        async with resource_manager.db_semaphore:
            try:
                ...
                updated_status = await resource_manager.db_manager.update_world_generation_progress(
                    world_id=world_id,
                    updates=updates
                )
    ...
    async def get_world_parameters(
        world_id: str
    ) -> Dict[str, Any]:
        """
        ...
        async with resource_manager.db_semaphore:
            try:
                ...
                world_params = await resource_manager.db_manager.get_world_parameters(world_id)
    ...
    async def create_character(
        ...
        async with resource_manager.grpc_semaphore:
            try:
                ...
                character_id, _ = await resource_manager.service_client.create_character(
                    world_id=world_id,
                    display_name=character_data.get("display_name", character_data.get("username", "Unknown")),
                    meta=character_data,
    ...
    async def update_task(
        ...
        async with resource_manager.db_semaphore:
            try:
                ...
                success = await resource_manager.db_manager.update_task(task_id, updates)
