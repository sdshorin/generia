...
class MongoDBManager:
    ...
    async def save_world_parameters(self, params: WorldDescription) -> str:
        """
        ...
        """
        # Преобразуем модель в словарь для MongoDB
        params_dict = params.to_mongo(params.id)
    ...
    async def get_world_parameters(self, world_id: str) -> Optional[WorldDescription]:
        ...
        if doc:
            return WorldDescription.from_mongo(doc)
        return None
